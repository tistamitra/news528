            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <!--- insert category --->
                        <div class="card mb-4">
                            <div class="card-body">
                            <h4 class="mt-1 mb-3"> Insert Category </h4>
                     ...
                     <!---- icon ---->
                                ...
                                <div class="mb-3">
                                  <button type="submit" class="btn btn-success" name="c_submit"> Submit </button>
                    ...
                    <!----category info ----->
                        <div class="card mb-4">
                            <div class="card-body">
                                <h4 class="mt-1 mb-3"> Category Info </h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           <!--- <td>Gavin Joyce</td>
                                            ...
                                            <td>2010/12/22</td>
                                            <td>$92,575</td> ---->
                                        <td colspan="2"> <p> no data show </p> </td>
                                        </tr>
                                        <?php }?>
